...
const messages = {
  ...
  auth: {
    ...
    kudumbashreeMember: "I am a Kudumbashree member",
  ...
  orders: {
    ...
    reorder: "Reorder",
    review: "Review",
    itemsAddedToCart: "All items added to cart!",
  },
  vendorDashboard: {
  ...
  filters: {
    searchPlaceholder: "Search products / ഉൽപ്പന്നങ്ങൾ തിരയുക",
    all: "All",
    price: "Price",
    min: "Min",
    max: "Max",
  ...
  favourites: {
    ...
    tapHeart: "Tap the heart on any product to save it",
    browseProducts: "Browse products",
    addedToFavourites: "Added to favourites",
    removedFromFavourites: "Removed from favourites",
    loginToSave: "Please login to save items",
  },
  profile: {
